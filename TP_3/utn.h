...
/// @brief Funcion que obtiene un codigo de vuelo del usuario y tambien asigna el estado de vuelo correspondiente.
/// @param flycode Puntero a donde guardara el codigo de vuelo.
/// @param estadoVuelo Puntero a donde guardara el estado de vuelo.
/// @return Retorna 0 en caso de obtener los datos con exito y -1 en caso de error.
int getFlyCode(char* flycode, char* estadoVuelo);

/// @brief Le pide al usuario que ingrese un precio en formato char[];
/// @param precio Puntero a donde guardara el precio ingresado.
/// @return Retorna 0 si pudo obtener el precio y -1 en caso de error.
int getPrecioStr(char* precio);

/// @brief Funcion que printea el menu principal del programa.
void menu();
